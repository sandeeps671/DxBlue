<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Header.ascx.cs" Inherits="DxBlue.Header" %>
    ...
    <dx:BootstrapToolbar runat="server" ID="HeaderToolbar" ClientInstanceName="HeaderToolbar">
        ...
        <Items>
            ...
            <dx:BootstrapToolbarItem AdaptivePriority="2" Text="User Settings"
                ...
                <TextTemplate>
                    <dx:BootstrapImage runat="server" ImageUrl="~/Content/Idemo-user.svg"></dx:BootstrapImage>
                    <span>User Name</span>
                </TextTemplate>
                <Items>
