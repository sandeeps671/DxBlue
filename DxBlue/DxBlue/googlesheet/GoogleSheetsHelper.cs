...
namespace DxBlue.googlesheet
{
    public class GoogleSheetsHelper
    {
        ...
        static string ApplicationName = "consistent";
        ...
        {
            var myFileName = HttpContext.Current.Server.MapPath("~/prerequisites/googlesheet/keys/" + credentialFileName);
        ...
        public List<ExpandoObject> GetDataFromSheet(GoogleSheetParameters googleSheetParameters)
        {
            ...
            string range = "";
            if (googleSheetParameters.IsFullSheetAsRange)
            {
                range = googleSheetParameters.SheetName;
            }
            else
            {
    ...
    public class GoogleSheetParameters
    {
        ...
        public bool IsFullSheetAsRange { get; set; }
    }
