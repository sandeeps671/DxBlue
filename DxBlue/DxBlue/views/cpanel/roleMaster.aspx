<%@ Page Title="Role Master" Language="C#" MasterPageFile="~/views/root/Site1.Master" AutoEventWireup="true" CodeBehind="roleMaster.aspx.cs" Inherits="DxBlue.cons.views.cpanel.roleMaster" %>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content modal-dialog-scrollable" role="document">
                <div class="modal-header bg-info py-2">
                    <h6 class="modal-title text-white">Role Master Form</h6>
